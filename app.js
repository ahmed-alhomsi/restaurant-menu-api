...
const menuBtnsContainer = document.querySelector('.menu-btns');
  ...
  filterBtns.forEach(btn => {
    btn.addEventListener('click', (e) => {
      ...
      if(category === 'all') {
        ...
        showMenuItems(categoryMenu);
      }
      // if((btn.innerText).toLowerCase() !== 'all') {
      //   showSpecificCategoryMenuItem((btn.innerText).toLowerCase());
      // } else {
      //   showMenuItems(menu);
      // }
    });
...
function showSpecificCategoryMenuItem(category) {
